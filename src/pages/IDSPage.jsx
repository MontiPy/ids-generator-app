...
export default function IDSPage() {
  const [partInfo, setPartInfo] = useState({
    partNumber: '', partName: '', supplier: '', model: '', event: '', facility: '',
    drawingRank: '', regulationPart: '', sideLeft: false, sideRight: false,
    dpRegular: false, dpNewModel: false, dpProblem: false, dpOther: false,
    dpOtherText: ''
  });

  const [formValues, setFormValues] = useState({
    name: '', toleranceType: '', itemType: 'Variable', nominal: '', usl: '',
    lsl: '', controlPlan: 'N/A', method: '', sampleFreq: '', reportingFreq: ''
  });
      ...
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={1}>
        <Box minWidth={250}>
          <ItemForm
            ...
            onSubmit={() => handleAddOrUpdate(formValues, tolWithXY, tolWithMinMax, resetFormValues)}
